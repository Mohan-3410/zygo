...
import {QueensGrid} from '../components/QueensGrid';
import {useQueensGame} from '../hooks/useQueensGame';
import {useGameTimer} from '../../../shared/hooks/useGameTimer';
import {useHaptics} from '../../../shared/hooks/useHaptics';
import {colors} from '../../../theme';

type Props = NativeStackScreenProps<RootStackParamList, 'QueensGame'>;

export const QueensGameScreen: React.FC<Props> = ({navigation, route}) => {
